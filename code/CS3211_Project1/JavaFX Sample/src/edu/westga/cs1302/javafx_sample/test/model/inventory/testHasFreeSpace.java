...
class testHasFreeSpace {
	...
	void testInventoryHasFreeSpace() {
		...
		Stock stock = new Stock(2, false, "gold", "good", "12/12/2025");
		assertTrue(inventory.hasFreeSpace(stock));
	}
	
	@Test
	void testInventoryDoesNotFreeSpace() {
		Inventory inventory = new Inventory();
		Stock stock = new Stock(999, false, "gold", "good", "12/12/2025");
		assertFalse(inventory.hasFreeSpace(stock));
	}
