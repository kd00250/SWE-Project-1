	...
	void filterResultsListView(ActionEvent event) {
		...
		if (this.chooseSortComboBox.getValue().equals("Date") && this.endDatePicker.getValue() == null) {
			...
			if (startDate != null) {
				...
				this.changeResultsListView.getItems()
						.setAll(FXCollections.observableArrayList(this.reviewVM.getStartDateFilter(startDateString)));
			}
		}
		if (this.chooseSortComboBox.getValue().equals("Date") && this.endDatePicker.getValue() != null) {
			LocalDate startDate = this.startDatePicker.getValue();
			...
			if (endDate.isBefore(startDate)) {
				...
				this.changeResultsListView.getItems().setAll(FXCollections
						.observableArrayList(this.reviewVM.getStartAndEndDateFilter(startDateString, endDateString)));
			}
		}
	}
