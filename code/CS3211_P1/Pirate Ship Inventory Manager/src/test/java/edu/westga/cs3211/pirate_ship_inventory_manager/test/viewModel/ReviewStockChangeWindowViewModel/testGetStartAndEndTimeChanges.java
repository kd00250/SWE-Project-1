...
class testGetStartAndEndTimeChanges {
	...
	void testGetStartFilterHours() {
        ...
        assertEquals(vm.getStartAndEndTimeChanges(vm.getStartDateFilter(vm.getStartDate().get()), vm.getHoursStartDate().get(), "", "", vm.getHoursEndDate().get(), "", "").get(0), change.getDisplayString());
        assertEquals(vm.getStartAndEndTimeChanges(vm.getStartDateFilter(vm.getStartDate().get()), vm.getHoursStartDate().get(), "", "", vm.getHoursEndDate().get(), "", "").size(), 1);
	}
